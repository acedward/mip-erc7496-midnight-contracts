...
const _descriptor_2 = new __compactRuntime.CompactTypeBytes(190);
...
class _Either_0 {
  alignment() {
    return _descriptor_3.alignment().concat(_descriptor_0.alignment().concat(_descriptor_4.alignment()));
  }
  fromValue(value_0) {
    return {
  ...
  toValue(value_0) {
    return _descriptor_3.toValue(value_0.is_left).concat(_descriptor_0.toValue(value_0.left).concat(_descriptor_4.toValue(value_0.right)));
  }
}
...
class _Either_1 {
  alignment() {
    return _descriptor_3.alignment().concat(_descriptor_7.alignment().concat(_descriptor_4.alignment()));
  }
  fromValue(value_0) {
    return {
      is_left: _descriptor_3.fromValue(value_0),
  ...
  toValue(value_0) {
    return _descriptor_3.toValue(value_0.is_left).concat(_descriptor_7.toValue(value_0.left).concat(_descriptor_4.toValue(value_0.right)));
  }
}
...
const _descriptor_11 = new __compactRuntime.CompactTypeBytes(16);
...
class _CoinPreimage_0 {
  alignment() {
    return _descriptor_16.alignment().concat(_descriptor_10.alignment().concat(_descriptor_3.alignment().concat(_descriptor_0.alignment())));
  }
  fromValue(value_0) {
    return {
  ...
  toValue(value_0) {
    return _descriptor_16.toValue(value_0.domain_sep).concat(_descriptor_10.toValue(value_0.info).concat(_descriptor_3.toValue(value_0.dataType).concat(_descriptor_0.toValue(value_0.data))));
  }
}

const _descriptor_17 = new _CoinPreimage_0();

const _descriptor_18 = new __compactRuntime.CompactTypeVector(1, _descriptor_0);
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      ...
      mintPiece: async (...args_1) => {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(pieceDomain_0).concat(_descriptor_8.toValue(recipient_0).concat(_descriptor_0.toValue(nonce_0))),
      ...
      publishPiece: async (...args_1) => {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(pieceDomain_0).concat(_descriptor_0.toValue(nameBytes_0).concat(_descriptor_1.toValue(nameLen_0))),
      ...
      setPieceTrait: async (...args_1) => {
        if (args_1.length !== 5) {
          throw new __compactRuntime.CompactError(`setPieceTrait: expected 5 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const pieceDomain_0 = args_1[1];
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(pieceDomain_0).concat(_descriptor_0.toValue(key_0).concat(_descriptor_1.toValue(len_0).concat(_descriptor_2.toValue(value_0)))),
      ...
      owner: async (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.callContext.currentQueryContext != undefined)) {
          __compactRuntime.typeError('owner',
                                     'argument 1 (as invoked from Typescript)',
                                     'ShieldedCollection.compact line 114 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        const context = __compactRuntime.copyCircuitContext(contextOrig_0);
                                      ...
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_1.toValue(1n),
                                                                                              alignment: _descriptor_1.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_5.toValue({ is_left: false, left: new Uint8Array(32), right: { bytes: new Uint8Array(32) } }),
                                      ...
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_1.toValue(6n),
                                                                                              alignment: _descriptor_1.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_11.toValue(new Uint8Array(16)),
                                      ...
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_1.toValue(6n),
                                                                                              alignment: _descriptor_1.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_11.toValue(symbolBytes__0),
                                                                                              alignment: _descriptor_11.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_1.toValue(7n),
                                                                                              alignment: _descriptor_1.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_1.toValue(symbolLen__0),
                                                                                              alignment: _descriptor_1.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
                             ...
                             recipient_0)
  {
    ...
    __compactRuntime.queryLedgerState(context,
                                      ...
                                      [
                                       ...
                                       'member',
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_12.toValue(value_0),
                                                                                              alignment: _descriptor_12.alignment() }).encode() } },
                                       { swap: { n: 0 } },
                                       'neg',
                                       { branch: { skip: 4 } },
                                       ...
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newArray()
                                                          .arrayPush(__compactRuntime.StateValue.newCell({ value: _descriptor_20.toValue(1n),
                                                                                                           alignment: _descriptor_20.alignment() })).arrayPush(__compactRuntime.StateValue.newCell({ value: _descriptor_1.toValue(10n),
                                                                                                                                                                                                     alignment: _descriptor_1.alignment() })).arrayPush(__compactRuntime.StateValue.newCell({ value: _descriptor_14.toValue((t_0 = { name:
                                      ...
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_1.toValue(1n),
                                                                                              alignment: _descriptor_1.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_5.toValue(canonAcct_0),
                                                                                              alignment: _descriptor_5.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
    return [];
  }
                                      ...
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_1.toValue(3n),
                                                                                              alignment: _descriptor_1.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_13.toValue(name__0),
                                                                                              alignment: _descriptor_13.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_1.toValue(4n),
                                                                                              alignment: _descriptor_1.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_13.toValue(symbol__0),
                                                                                              alignment: _descriptor_13.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
